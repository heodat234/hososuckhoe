<div class="container">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="col-xs-12 col-sm-12 col-md-12 pull-left" style="margin-bottom: 10px;">
            <div class="no-pad icon-boxes-1"> 
                ...
                <div class="col-sm-6 col-xs-12 col-md-3 col-lg-3">
                 <div class="icon-box-3 wow fadeInUp" data-wow-delay="0.6s" data-wow-offset="150">
                    ...
                    <h2 class="icon-box2-title">Lưu trữ hồ sơ</h2>
                ...
                <div class="col-sm-6 col-xs-12 col-md-3  col-lg-3">
                 <div class="icon-box-3 wow fadeInDown" data-wow-delay="0.9s" data-wow-offset="150">
                    ...
                    <h2 class="icon-box2-title">Hỗ trợ điều trị</h2>
                ...
                <div class="col-sm-6 col-xs-12 col-md-3 col-lg-3">
                 <div class="icon-box-3 wow fadeInUp" data-wow-delay="1.2s" data-wow-offset="150">
                    ...
                    <h2 class="icon-box2-title">Giải pháp mới</h2>
                ...
                <div class="col-sm-6 col-xs-12 col-md-3 col-lg-3">
                 <div class="icon-box-3 wow fadeInUp" data-wow-delay="1.2s" data-wow-offset="150">
                    ...
                    <h2 class="icon-box2-title">Tra cứu nhanh</h2>
...
<div class="parallax-out wpb_row vc_row-fluid ihome-parallax">    
    <div id="second" class="upb_row_bg vcpb-hz-jquery" data-upb_br_animation="" data-parallax_sense="30" data-bg-override="ex-full">
        <div class="container">
            <div class="bg col-lg-4 col-sm-4 col-md-5 col-xs-12 notViewed wow fadeInUp animated"></div>
            <div class="float-right col-lg-7 col-sm-7 col-md-7 col-xs-12">
                <div class="iconlist-wrap">
                    <h1>Hồ sơ sức khỏe trực tuyến đầu tiên tại Việt Nam</h1>
                    <p class="iconlist-text">Sức khỏe là phần thiết yếu trong cuộc sống của tất cả mọi người. Không có sức khỏe đồng nghĩa với cuộc sống không thật sự hạnh phúc. Nhằm nâng cao ý thức của người Việt Nam trong việc chủ động bảo vệ sức khỏe cá nhân. Trang web của chúng tôi cung cấp nơi lưu trữ kết quả khám chữa bệnh: kết quả xét nghiệm máu, siêu âm, x- quang...</p>
                    <p class="iconlist-text">Lợi ích mang đến :</p>
                        <p class="iconlist-text-a">- Không lo mất các kết quả xét nghiệm, lưu giữ trọn đời toàn bộ kết quả khám chữa bệnh.</p>
                        <p class="iconlist-text-a">- Tra cứu tiện lợi, bạn và bác sĩ có thể xem lại quá trình điều trị, diễn biến bệnh, phác đồ điều trị. Từ đó sẽ có những cập nhật kịp thời.</p>
                        <p class="iconlist-text-a">- Cập nhật tin tức y khoa, tra cứu đánh giá xếp hạng các bệnh viện, phòng khám, bác sĩ.</p>
                        <p class="iconlist-text-a">- Mua thuốc ở đâu, giá thuốc bao nhiêu. Chúng tôi cung cấp cho bạn thông tin tham khảo trong khả năng của chúng tôi.</p>
                    <p class="iconlist-text">Xin cảm ơn !!!</p>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="">
                <div class="col-xs-12 col-sm-12 col-md-4  styNew">
                    <div class="latest-post-wrap pull-left wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="100" >
                        ...
                        <?php for($i = 0; $i<2;$i++): ?>
                            <div class="post-item-wrap col-sm-6 col-md-12 col-xs-12">
                                <?php if (isset( $tintuc[$i])){?>
                                    <div class="post-content1 col-md-12 col-sm-12 col-xs-12">
                                        <h3 class="post-title "><a href="<?php echo base_url().'tintuc/'.$tintuc[$i]['id'].'-'.to_slug($tintuc[$i]['title']).'.html'?>"><?php echo $tintuc[$i]['title'] ?></a></h3>
                          ...
                          <?php } ?>
                                        <div clas="post-meta-top">
                                            <ul class="nav nav-tabs pull-right" id="calendar">
                                                <li class="ngaydang"><i class="icon-calendar"></i><?php echo date('d-m-Y',strtotime($tintuc[$i]['created_at'])) ?></li> 
                                                <li><i class="fa fa-eye"></i> <?php echo $tintuc[$i]['view'] ?></li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4  department-wrap wow fadeInRight tracuu">
                    <div class="subtitle">
                        <div class="title-a">Tra cứu</div>
                        <div class="title-b"><p></p></div>
                    </div>
                    <div >
                        <h3 class="tab_thongtin"><i class="icon-ambulance dept-icon"></i><span class="dep-txt">Bệnh viện</span></h3>
                        <div>
                        ...
                        <h3 class="tab_thongtin"><i class="icon-stethoscope dept-icon"></i><span class="dep-txt">Bác sĩ</span></h3>
                        <div>
                        ...
                        <h3 class="tab_thongtin"><i class="icon-heart dept-icon"></i><span class="dep-txt">Thuốc</span></h3>
                        <div>
                        ...
                        <h3 class="tab_thongtin"><i class="icon-stethoscope dept-icon"></i><span class="dep-txt">Tin tức y khoa</span></h3>
                        <div>
