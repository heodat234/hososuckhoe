...
<div class="mednow-appointment-route-content">
	<div id="mednow">
		...
		<h2 class="aliments-header">Các chỉ số khám bệnh trong đợt điều trị:</h2>
                ...
                <div  style="margin-left: 2px; margin-right: 10px">
                    ...
                    <div >
                      <div class="col-12 col-md-6">
                        <input type="text" name="chiso_0" list="cs" class="form-control" placeholder="Bạn vui lòng nhập các chỉ số xét nghiệm để theo dõi" required="">
